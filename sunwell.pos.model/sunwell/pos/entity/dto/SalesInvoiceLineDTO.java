...
public class SalesInvoiceLineDTO extends StandardDTO 
{
    ...
    public SalesInvoiceLineDTO (SalesInvoiceLine _line)
    {
        setData (_line);
    }

    public void setData(SalesInvoiceLine _line) {
        systemId = _line.getSystemId ();
        ...
        salesInvoiceId = _line.getParent ().getSystemId ();
    }
